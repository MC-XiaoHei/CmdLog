...
public final class CommandMessages {
    ...
    public List<String> buildHelpLines() {
        return List.of(
            ...
            "§7--from <时间>        起始时间，如 2026-01-01 12:00:00、20260501、-1d",
            "§7--to <时间>          结束时间，如 2026-01-01 18:00:00、20260501、-1h",
            "§7--limit <数量>       限制返回条数",
            "§7相对时间单位：s=秒，m=分，h=小时，d=天，w=周",
            "§7示例：",
            ...
            "§7  /cmdlog --from 20260510 --to 20260511 §8(查询 2026-05-10 到 2026-05-11)",
            "§7  /cmdlog --from -1d §8(查询最近 1 天)"
        );
    }
